        ...
        <div className="Inclusive-readList-page">
          ...
          <div className="readList-top-block">
            ...
            <div className="activeUser-info-wrapper">
              ...
              <div>
                ...
                <span>-</span>
                <span>
                  {activeUser.readListLength > 1
                    ? activeUser.readListLength + " postagens"
                    : activeUser.readListLength + " postagem"}
                </span>
                <i>
                  <AiFillLock />
                </i>
          ...
          <div className="readList-story-wrapper">
            {readList.length !== 0 ? (
              ...
              <div className="empty-readList">Lista de leitura vazia.</div>
            )}
          </div>
        </div>
      )}
