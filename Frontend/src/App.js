      ...
      <div className="App">
        <Routes>
          <Route path="/" element={<LayoutsWithHeader />}>
            ...
            <Route exact path="/story/:_id" element={<DetailStory />} />
            ...
            <Route exact path="/story/:_id/like" element={<PrivateRoute />}>
              <Route exact path="/story/:_id/like" element={<DetailStory />} />
            </Route>

            <Route exact path="/story/:_id/edit" element={<PrivateRoute />}>
              <Route exact path="/story/:_id/edit" element={<EditStory />} />
            </Route>
            ...
            <Route exact path="/read-list" element={<PrivateRoute />}>
              <Route exact path="/read-list" element={<ReadListPage />} />
            </Route>
          </Route>
